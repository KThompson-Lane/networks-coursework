...
public class Speaker implements Runnable {
    ...
    public Speaker(int portNum, InetAddress destAddress, long key, int socketNum, boolean interleaving, boolean encrypt) {
        ...
        //  Set up VOIP layer
        voipLayer = new VoipLayer(false, interleaving);
